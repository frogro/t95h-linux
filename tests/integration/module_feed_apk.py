...
with tempfile.TemporaryDirectory(prefix='t95h-feed-fixture-') as tmp:
 ...
 module_feed.split(root,'7.2.3-test',t/'feed',providers,'7.2.3-r99999','0~abc','https://github.com/frogro/t95h-linux/releases/download/t95h-feedtest-1-1',apk,fakeroot,key,keys,1780000000,env)
