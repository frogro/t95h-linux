...
'''
 ...
 notes += '\n## Früherer Panfrost-Start (Profile B und A+B)\n\nGPU-Mindestwartezeit auf 45 statt 120 Sekunden reduziert. Die 15 aufeinanderfolgenden Bereitschaftsprüfungen für WLAN und Spannungsregler ohne LAN-Kabel-Abhängigkeit bleiben erhalten; tatsächlicher Start kann später erfolgen. Der frühere Start wurde unter AnotterKiosk dreimal beobachtet, ist mit diesem OpenWrt-Image aber noch hardwareseitig zu bestätigen. Frühe deferred-probe-Meldungen und gelegentliche Bootprobleme gelten dadurch nicht als behoben.\n'
