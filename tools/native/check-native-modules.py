...
required=['VIDEO_SUN50I_DI300','SND_USB_AUDIO','USB_NET_RNDIS_HOST','VIDEOBUF2_VMALLOC','SOUND','SND','SND_PCM','SND_COMPRESS_OFFLOAD','ARM_ALLWINNER_SUN50I_CPUFREQ_NVMEM','DRM_PANFROST','DRM_SUN4I','DRM_SUN8I_MIXER','DRM_SUN8I_DW_HDMI','VIDEO_SUNXI_CEDRUS','SND_SUN4I_CODEC','SND_SOC_SUNXI_AHUB','IR_SUNXI','BT_HCIBTUSB']
...
files=['sound/usb/snd-usb-audio.ko','drivers/net/usb/rndis_host.ko','drivers/media/common/videobuf2/videobuf2-vmalloc.ko']
